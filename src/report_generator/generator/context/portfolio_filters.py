...
METADATA_DEPLOYMENT_MAPPING = {x: x.lower().capitalize().replace('_', '-') for x in
                               ["PUBLIC_FACING", "CONNECTED", "INTERNAL", "PHYSICAL"]}
METADATA_BUSINESS_CRITICALITY_MAPPING = {x: x.lower().capitalize() for x in ["CRITICAL", "HIGH", "MEDIUM", "LOW"]}
METADATA_DISTRIBUTION_MAPPING = {x: x.lower().capitalize().replace('_', ' ') for x in
                                 ["NOT_DISTRIBUTED", "NETWORK_SERVICE", "DISTRIBUTED"]}
METADATA_APPLICATION_TYPE_MAPPING = {x: x.lower().capitalize().replace('_', ' ') for x in
                                     ["PROCESS_CONTROLLER", "TRANSACTION_PROCESSING", "RESOURCE_MANAGEMENT",
...
METADATA_TARGET_INDUSTRY_MAPPING = {"ICD0500": "Oil & Gas", "ICD1750": "Industrial Metals & Mining",
                                    "ICD2350": "Construction & Materials", "ICD2710": "Aerospace & Defense",
                                    "ICD2730": "Electronic & Electrical Equipment", "ICD2750": "Industrial Engineering",
                                    "ICD2770": "Industrial Transportation", "ICD2790": "Support Services",
                                    "ICD2797": "Industrial Suppliers", "ICD3350": "Automobiles & Part",
                                    "ICD3500": "Food & Beverage", "ICD3700": "Personal & Household Goods",
                                    "ICD4500": "Health Care", "ICD5300": "Retail", "ICD5500": "Media",
                                    "ICD5700": "Travel & Leisure", "ICD6500": "Telecommunications", "ICD7500": "Energy",
                                    "ICD7577": "Water", "ICD8300": "Banking", "ICD8500": "Insurance",
                                    "ICD8630": "Real Estate Investment & Services", "ICD8700": "Financial Services",
                                    "ICD9530": "Software & Computer Services",
                                    "ICD9570": "Technology hardware & equipment", "SIG2200": "Legal Services",
                                    "SIG1200": "Research", "SIG1000": "Government", "SIG1100": "Education"}
METADATA_TECHNOLOGY_CATEGORY_MAPPING = {x: x.lower().capitalize().replace("_", " ") for x in
                                        ["AGGREGATE", "BPM", "CUSTOMIZATION", "CONFIGURATION", "DATABASE", "DSL",
...
def portfolio_arguments_command():
    def decorator(func):
        ...
        @click.option('--lifecycle', multiple=True,
        ...
        @click.option('--deployment', multiple=True,
        ...
        @click.option('--business-criticality', multiple=True,
        ...
        @click.option('--distribution', multiple=True,
        ...
        @click.option('--application-type', multiple=True,
        ...
        @click.option('--target-industry', multiple=True,
        ...
        @click.option('--technology-category', multiple=True,
        ...
        @click.option('--main-technology', multiple=True,
        ...
        @wraps(func)
        def wrapper(team, division, lifecycle, deployment, business_criticality, distribution, application_type,
                    target_industry, technology_category, main_technology, *args, **kwargs):
            set_context(team=team, division=division, lifecycle=lifecycle, deployment=deployment,
                        business_criticality=business_criticality,
                        distribution=distribution, application_type=application_type, target_industry=target_industry,
                        technology_category=technology_category, main_technology=main_technology)
...
def _with_data_tag(data, portfolio_metadata, data_tag, system_tag):
    systems = [entry for entry in data[data_tag] if
               _include(system_name=entry[system_tag], portfolio_metadata=portfolio_metadata)]
    data[data_tag] = systems
    return data


def _without_data_tag(data, portfolio_metadata, system_tag):
    systems = [entry for entry in data if
               _include(system_name=entry[system_tag], portfolio_metadata=portfolio_metadata)]
    return systems
