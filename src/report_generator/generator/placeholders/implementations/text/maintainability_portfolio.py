...
def portfolio_period_maint_summary():
    ...
    if stats["maintainability"]["5-star"] + stats["maintainability"]["4-star"] > 0:
        res.append(
            _format_maintainability_statement(
                stats["maintainability"]["5-star"] + stats["maintainability"]["4-star"],
    ...
    if stats["maintainability"]["2-star"] + stats["maintainability"]["1-star"] > 0:
        res.append(
            _format_maintainability_statement(
                stats["maintainability"]["2-star"] + stats["maintainability"]["1-star"],
                stats["maintainability"]["number-of-systems"],
...
def portfolio_period_maint_short_summary():
    ...
    processed_stats = {
        ...
        "below-market-average": stats["maintainability"]["2-star"]
        + stats["maintainability"]["1-star"],
    }
    postfixes = {
    ...
    res = _format_short_maintainability_statement(
        processed_stats[key],
        stats["maintainability"]["number-of-systems"],
        postfixes[key],
    )
...
def portfolio_period_maint_change_summary():
    ...
    if stats["maintainability-change"]["biggest-increase"]:
        ...
        res.append(
            f"The largest increase in maintainability rating was experienced by {portfolio_display_name(key)} ({int(10 * stats['maintainability-change']['biggest-increase'][key]) / 10})."
        )
...
def portfolio_maint_biggest_changes():
    ...
    if biggest_increase:
        ...
        res.append(
            f"The largest increase in maintainability rating was experienced by {portfolio_display_name(system)} ({int(diff * 10) / 10} stars)."
        )
    ...
    if biggest_decrease:
        ...
        res.append(
            f"The largest decrease in maintainability rating was experienced by {portfolio_display_name(system)} ({int(diff * 10) / 10} stars)."
        )
    if res:
        return " ".join(res)
    return ""
...
def portfolio_maint_largest_increase_system():
    ...
    biggest_increase = stats["maintainability-change"]["biggest-increase"]
    if biggest_increase:
        return portfolio_display_name(next(iter(biggest_increase.keys())))
    return None
...
def portfolio_maint_largest_decrease_system():
    ...
    biggest_decrease = stats["maintainability-change"]["biggest-decrease"]
    if biggest_decrease:
        return portfolio_display_name(next(iter(biggest_decrease.keys())))
    return None
...
def portfolio_test_code_biggest_changes():
    ...
    if biggest_increase:
        ...
        res.append(
            f"The largest increase in test code ratio was experienced by {portfolio_display_name(system)} (+{percentage_change}%)."
        )
    ...
    if biggest_decrease:
        ...
        res.append(
            f"The largest decrease in test code ratio was experienced by {portfolio_display_name(system)} (-{percentage_change}%)."
        )
    if res:
        return " ".join(res)
    return ""
