...
class TestPortfolioPlaceholders:
    ...
    def test_portfolio_security_placeholders_return_distribution_values(self, mocker):
        ...
        assert security_ratings_portfolio_data.get_rating_distribution_percentages['above_market'] == pytest.approx(
            60.0)
        assert security_ratings_portfolio_data.get_rating_distribution_percentages['market_average'] == pytest.approx(
            25.0)
        assert security_ratings_portfolio_data.get_rating_distribution_percentages['below_market'] == pytest.approx(
            15.0)
