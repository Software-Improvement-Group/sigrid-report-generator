...
# noinspection PyProtectedMember
from report_generator.generator.domain.portfolio.maintainability_portfolio import (MaintainabilityPortfolioData,
...
class TestMaintainabilityStatistics:
    ...
    def test_statistics_with_changes(self, mocker):
        ...
        # Mock period
        mocker.patch.object(type(portfolio), 'period', new_callable=mocker.PropertyMock,
        ...
        mocker.patch.object(type(portfolio), 'system_names', new_callable=mocker.PropertyMock,
        ...
        mocker.patch('report_generator.generator.domain.portfolio.shared.utils.get_system_metadata',
    ...
    def test_statistics_all_stable(self, mocker):
        ...
        mocker.patch.object(type(maintainability_portfolio_data), 'period', new_callable=mocker.PropertyMock,
                            return_value=['2024-01-01', '2024-12-31'])
...
class TestTestCodeRatioChange:
    ...
    def test_test_code_ratio_change_tracking(self, mocker):
        ...
        def mock_start_snapshot(system_name):
            snapshots = {
                'system1': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-02-01', 'testCodeRatio': 0.5,
                            'volumeInPersonMonths': 100},
                'system2': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-02-01', 'testCodeRatio': 0.8,
                            'volumeInPersonMonths': 100},
                'system3': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-02-01', 'testCodeRatio': 0.6,
                            'volumeInPersonMonths': 100},
                'system4': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-02-01', 'testCodeRatio': 0.4,
                            'volumeInPersonMonths': 100}
            }
            return snapshots[system_name]
        ...
        def mock_end_snapshot(system_name):
            snapshots = {
                'system1': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-12-31', 'testCodeRatio': 0.7,
                            'volumeInPersonMonths': 100},
                'system2': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-12-31', 'testCodeRatio': 0.6,
                            'volumeInPersonMonths': 100},
                'system3': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-12-31', 'testCodeRatio': 0.9,
                            'volumeInPersonMonths': 100},
                'system4': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-12-31', 'testCodeRatio': 0.41,
                            'volumeInPersonMonths': 100}
            }
            return snapshots[system_name]
    ...
    def test_test_code_ratio_change_with_none_values(self, mocker):
        ...
        def mock_start_snapshot(system_name):
            snapshots = {
                'system1': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-02-01', 'testCodeRatio': 0.5,
                            'volumeInPersonMonths': 100},
                'system2': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-02-01', 'testCodeRatio': None,
                            'volumeInPersonMonths': 100},
                'system3': {'maintainability': 3.5, 'maintainabilityDate': '2024-02-01', 'volumeInPersonMonths': 100}
        ...
        def mock_end_snapshot(system_name):
            snapshots = {
                ...
                'system2': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-12-31', 'testCodeRatio': 0.6,
                            'volumeInPersonMonths': 100},
                'system3': {'maintainability'     : 3.5, 'maintainabilityDate': '2024-12-31', 'testCodeRatio': None,
                            'volumeInPersonMonths': 100}
            }
            return snapshots[system_name]
    ...
    def test_test_code_ratio_change_no_changes(self, mocker):
        ...
        def mock_start_snapshot(system_name):
            return {'maintainability'     : 3.5, 'maintainabilityDate': '2024-02-01', 'testCodeRatio': 0.5,
                    'volumeInPersonMonths': 100}

        def mock_end_snapshot(system_name):
            return {'maintainability'     : 3.5, 'maintainabilityDate': '2024-12-31', 'testCodeRatio': 0.5,
                    'volumeInPersonMonths': 100}
...
class TestMaintainabilityPortfolioData:
    ...
    @patch('report_generator.generator.domain.portfolio.maintainability_portfolio.sigrid_api')
